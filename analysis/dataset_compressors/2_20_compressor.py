...
ROOT = "/home/gridsan/groups/robustness/data-transfer-exps/models_2_20_22_50_percenters"
save_path = "/home/gridsan/groups/robustness/data-transfer-exps/summary_files/models_2_20_22_50_percenters_summaries"
...
def create_dict(out, ds_name):
    class_binary_mask = torch.zeros(1000).int()
    class_binary_mask[out['classes_to_keep']] = 1
    keys_to_keep = ['is_corrects', 'predictions', 'softmax_logits', 'acc', 'softmax_margins', 'raw_margins']
    ...
    for k in keys_to_keep:
        for k2 in ['transfer_results_full', 'transfer_results']:
            result_dict[k2][k] = out['transfer_datasets'][ds_name][k2][k]
    return result_dict
